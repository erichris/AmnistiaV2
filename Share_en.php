					...
					<div class="contendor-inferior">
						...
						<div class="cont-btn-7">
							<div class="cont-titulo">
									<h1 class="titulo-7" style="text-align: center;">you have disinfected your profile</h1>
							</div>
							<p class="texto-7">Share the Antivirus App with your friends.<br> Let’s remove sexist language from social media!
							</p>
